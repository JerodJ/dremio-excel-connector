...
@SourceType(value = "ExcelARP", label = "Excel",uiConfig = "excel-layout.json")
public class ExcelConf extends AbstractArpConf<ExcelConf> {
  private static final String ARP_FILENAME = "arp/implementation/excel-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.excel.ExcelDriver";
